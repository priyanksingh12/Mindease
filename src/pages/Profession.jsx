      ...
      {showGuide && (
        <div className="fixed inset-0 flex justify-center items-center z-50 px-4 bg-black/60">
          <div className="relative flex items-center">
            <img src={Doctor} alt="Doctor" className="w-48 sm:w-60 md:w-72 lg:w-80 drop-shadow-2xl mr-4" />
            <div className="relative flex flex-col items-center">
              <img src={Cloud} alt="Cloud Bubble" className="w-52 sm:w-60 md:w-64 lg:w-72" />
              <p
                className="
            ...
            <section ref={featuresRef} className="max-w-6xl mx-auto px-6 md:px-12 py-12">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                <div className="bg-backg rounded-2xl shadow-md p-6 text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-xl border-2 border-darkblue hover:border-darkblue">
                  ...
                  <h4 className="text-xl font-bold text-darkblue mb-2">Guided Meditations</h4>
                ...
                >
                  ...
                  <h4 className="text-xl font-bold text-darkblue mb-2">Mental Wellness Check</h4>
                  <p className="text-darkblue text-sm">
                ...
                <div className="bg-backg rounded-2xl shadow-md p-6 text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-xl border-2 border-darkblue hover:border-darkblue">
                  <div className="w-16 h-16 mx-auto mb-4"></div>
                  <h4 className="text-xl font-bold text-darkblue mb-2">Mood Detection</h4>
                  <p className="text-darkblue text-sm">
                ...
                <div className="bg-backg rounded-2xl shadow-md p-6 text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-xl border-2 border-darkblue hover:border-darkblue">
                  <div className="w-16 h-16 mx-auto mb-4"></div>
                  <h4 className="text-xl font-bold text-darkblue mb-2">Daily Journal</h4>
                  <p className="text-darkblue text-sm">
                ...
                <div className="bg-backg rounded-2xl shadow-md p-6 text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-xl border-2 border-darkblue hover:border-darkblue">
                  <div className="w-16 h-16 mx-auto mb-4"></div>
                  <h4 className="text-xl font-bold text-darkblue mb-2">AI Companion</h4>
                  <p className="text-darkblue text-sm">
                ...
                <div className="bg-backg rounded-2xl shadow-md p-6 text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-xl border-2 border-darkblue hover:border-darkblue">
                  <div className="w-16 h-16 mx-auto mb-4"></div>
                  <h4 className="text-xl font-bold text-darkblue mb-2">Community Space</h4>
                  <p className="text-darkblue text-sm">
          ...
          <section className="py-16 space-y-20 px-6 md:px-20">
            <div className="flex flex-col md:flex-row items-center mx-20">
              <div className="md:w-1/2 mx-10">
                ...
                <span className="text-darkblue text-4xl font-bold mb-3">Welcome to your </span>
                <br />
